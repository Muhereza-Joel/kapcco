                    ...
                    <table class="table table-striped datatable" id="up-paid-collections-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img width="40px" height="40px" class="rounded-circle mx-3" src="<?php echo e($collection['image_url']); ?>"> <?php echo e($collection['fullname']); ?></td>
                                ...
                                <td><a class="btn btn-success btn-sm" id="clear-collection-btn" href="/<?php echo e($appName); ?>/dashboard/colllections/up-paid/clear?id=<?php echo e($collection['id']); ?>}">Clear</a></td>
                            </tr>
