                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="actionDropdown">
                        <a class="dropdown-item" href="?action=view&id=<?php echo e($farmer['id']); ?>" class="mx-1 p-1">View Farmer Details</i></a>

                        <?php if($farmer['approved'] == '1'): ?>
                        <a class="dropdown-item" href="/kapcco/dashboard/farmers/u/?action=allocate-store&id=<?php echo e($farmer['id']); ?>" class="mx-1 p-1">Assign Stores</i></a>
                        <a class="dropdown-item text-danger" href="/kapcco/dashboard/farmers/u/?action=drop-store-allocation&id=<?php echo e($farmer['id']); ?>" class="mx-1 p-1">Remove Stores Assigned</a>
                        <?php endif; ?>
                      </div>
      ...
      <div class="col-lg-4">
        <div style="position: sticky; top: 100px;">
          <div class="assign-stores-container">
            ...
            <?php if($action == 'drop-store-allocation'): ?>
            <div class="card">
              <div class="card-body">
                ...
                <div id="farmer-to-drop-assignments" class="d-none"><?php echo e($userDetails['user_id']); ?></div>
                ...
                <table id="assignments-to-drop-table" class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <input type="checkbox" class="row-select" value="<?php echo e($store['assignment_id']); ?>">
                      </td>
